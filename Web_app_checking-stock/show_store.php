...
if($_SESSION['Position'] != 'Admin' && $_SESSION['Position'] != 'GM' ){
    echo 
    '<script>
        window.location = "admin_show_store.php"; //หน้าที่ต้องการให้กระโดดไป
    </script>';
    exit();
}else
            ...
            <div class="row">
                ...
                <div class="col-6 mt-2 ">
                    ...
                    <h1 class=" text-dark">
                        Store
                        <!-- ปุ่มเพิ่ม -->
                        <a href="fr_store.php" class="btn btn-1 btn-success shadow-sm">Add Store <img src="png/store-w.png"
              ...
              ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$row["address_store"]?></td>

                                                <td>
                                                    <div class="btn-group" role="group"
                                                        aria-label="Basic outlined example">
                                                        <a href="edit_store.php?id_store=<?=$row["id_store"]?>"
                                                            class="btn btn-warning text-white">Edti <img src="png/edit.png"
                                                                width="20" height="20"></a>

                                                        <a href="delete_store.php?id=<?=$row["id_store"]?>"
