...
if($_SESSION['Position'] != 'Admin' && $_SESSION['Position'] != 'GM' ){
    echo 
    '<script>
        window.location = "admin_show_type.php"; //หน้าที่ต้องการให้กระโดดไป
    </script>';
    exit();
}else 
            ...
            <div class="row">
                ...
                <div class="col-6 mt-2 ">
                    ...
                    <h1 class=" text-dark">
                        Type Product
                        <!-- ปุ่มเพิ่ม -->
                        <a href="fr_type.php" class="btn btn-1 btn-success shadow-sm">Add Type <img src="png/type.png" alt=""
