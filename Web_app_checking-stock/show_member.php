...
if($_SESSION['Position'] != 'Admin' && $_SESSION['Position'] != 'HR' ){
    echo 
    '<script>
        window.location = "admin_show_member.php"; //หน้าที่ต้องการให้กระโดดไป
    </script>';
    exit();
}else 
            ...
            <div class="row">
                <div class="col">
                    <h1 class=" text-dark">
                        Member
                        <!-- ปุ่มเพิ่ม -->
                        <a href="formRegister.php" class="btn btn-1 btn-success shadow-sm">Add <img
                                src="png/add-user.png" alt="" width="25" height="25"></a>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group"
                                                        ...
                                                        <a href="edit_member.php?id=<?=$row["id"]?>"
                                                            class="btn btn-warning text-white">Edit <img
                                                                src="png/edit.png" width="20" height="20"></a>
