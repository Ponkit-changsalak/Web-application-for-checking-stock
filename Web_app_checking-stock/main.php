                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="show_product.php"><img src="png/pro.png" alt="" width="17"
                                    height="17" class="d-inline-block align-text-top"> Products</a>
                        </li>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="text-center">
                                        ...
                                        <a href="add_store+product.php?id=<?=$row["id_store"]?>"
                                            class="btn btn-1 btn-success btn-sm mt-3 mb-3" title="Add product to stock">
                                            <img src="png/add-w.png" width="20" height="20"></a>

                                        <a href="sold_store_product.php?id=<?=$row["id_store"]?>"
                                            class="btn btn-1 btn-danger btn-sm mt-3 mb-3" title="sell products">
                                            <img src="png/truck-loading.png" width="20" height="20"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body shadow-lg">
                            <div class="row">
                                ...
                                <div class=" col-md-6 float-right">
                                    <a href="fr_store.php" class="btn btn-success btn-sm">
                                        Add Store</a>
                                </div>
                            </div>
                        </div>
