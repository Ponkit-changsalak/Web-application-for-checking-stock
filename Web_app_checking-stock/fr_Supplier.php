...
<body onLoad="document.Supplier.SupplierName.focus()">
        ...
        <div class="container ">
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <a class="btn btn-success mt-4 mb-2 shadow-sm">Add Supplier <img src="png/building.png" alt=""
                            width="25" height="25"></a>

                    <div class="bg-white border rounded p-4 shadow">

                        <form class="row g-3 needs-validation" method="POST" name="Supplier">
                            ...
                            <div class="form-group mt-3 mb-2">
                                <label for="inputName">Product Service Type	</label>
