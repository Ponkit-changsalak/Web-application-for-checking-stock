                    ...
                    <div class="col text-center">
                        ...
                        <div class="text-center">
                            ...
                            <div class="bg-white border rounded p-4 shadow">
                                ...
                                <!-- Start Form -->
                                <form method="POST" action="delete_store_inpro.php">
                                        ...
                                        <table class="table caption-top table-striped ">
                                            ...
                                            <tbody>
                                                ...
                                                require_once 'connect_product.php';
                                                 ...
                                                 $stmt = $conn->prepare("SELECT * FROM store_product_ WHERE id_store = '$id' ");
                                                 $stmt->execute();
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control mb-1 mt-1" readonly
                                                            value="<?php echo $rows["id_product"]; ?>"></td>

                                                    <td>
                                                        <div class="text-center">
                                                            <input class="btn mb-1 mt-1"
