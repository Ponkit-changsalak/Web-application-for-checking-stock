...
if($_SESSION['Position'] != 'Admin' && $_SESSION['Position'] != 'Sale' ){
    echo 
    '<script>
        window.location = "admin_show_product.php"; //หน้าที่ต้องการให้กระโดดไป
    </script>';
    exit();
}else 
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="main.php"><img src="png/home.png" alt=""
                                width="17" height="17" class="d-inline-block align-text-top"> Home</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link active" href="show_member.php"><img src="png/user-3.png" alt="" width="17"
                                height="17" class="d-inline-block align-text-top"> Member</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link active" href="show_store.php"><img src="png/store-w.png" alt="" width="17"
                                height="17" class="d-inline-block align-text-top"> Store</a>
                    </li>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="logout.php" class="dropdown-item "
                            onclick="return confirm('ยืนยันการออกจากระบบ');"><img src="png/exit.png" alt="" width="17"
                                height="17" class="d-inline-block align-text-top"> Logout</a>
                    </ul>
                </div>
            </form>
        </div>
        ...
        <div class="row justify-content-md-center">
            <div class="col col-lg-5 mt-3">
                <form class="d-flex" role="search" method="post" action="search_product.php">
                    <input class="form-control me-2 shadow" type="search" placeholder="Search...name ,type ,band ,model"
                ...
                <div class="col">
                    ...
                    <div class="card card-custom bg-white border-white border-0">
                        ...
                        <div class="card-body" style="max-width: 540px;">
                            <p class="card-text  text-dark alert-link">[ Reamin: <?= $row['quantity'];?> ]</p>
                            <h5 class="card-title"><?= $row['name'];?> / [<?= $row['type_name'];?>]</h5>
                            <p class="card-text  text-primary alert-link">Price: <?= $row['price'];?> ฿</p>
                            ...
                            <a href="delete_product.php?id=<?=$row["id_product"]?>" class="btn btn-Danger"
                                title="Delete Product" onclick="Del(this.href);return false;">
