...
$ids =$_GET['id'];
$sql ="DELETE FROM tbl_member WHERE id = '$ids' ";
...
if($_SESSION['Position'] == 'GM' || $_SESSION['Position'] == 'Sale' || $_SESSION['Position'] == 'HR'){
    ...
    echo '<script>
                setTimeout(function() {
                swal({
                title: "Successfully deleted member ID: '.$ids.'",
                type: "success"
                }, function() {
                window.location = "show_member.php"; //หน้าที่ต้องการให้กระโดดไป
                });
            ...
            <div class="row">
                <div class="col">
                    <h1 class=" text-dark">
                        Member
                        <!-- ปุ่มเพิ่ม -->
                        <a href="formRegister.php" class="btn btn-1 btn-success shadow-sm">Add <img src="png/add-user.png"
