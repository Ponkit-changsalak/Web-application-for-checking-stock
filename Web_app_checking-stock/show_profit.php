                            ...
                            <table class="table caption-top table-striped ">
                                <thead class="table-dark ">
                                    <tr>
                                        ...
                                        <th scope="col">Profit Per Piece</th>
                                        <th scope="col">Percent Profit</th>
                                    </tr>
                                </thead>
                                <tbody id="tableBody">
                                    <?php 
                                require_once 'connect_product.php';
                                $stmt = $conn->prepare("SELECT ROW_NUMBER() OVER (ORDER BY p.id_product) as rownum,
                                                                p.id_product,
                                                                s.amount_sold,
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['average_cost_unitprice']; ?></td>
                                        <td><?php echo $row['average_cost_soldprice']; ?></td>
                                        <td><?php echo $row['profit']; ?></td>
                                        <td><?php echo $row['percent_profit']; ?></td>
                                    </tr>
                                    <?php
        }
        ?>
...
var topProductData = {
    labels: <?php echo json_encode($store); ?>,
    datasets: [{
        label: `Products for sale`,
        data: <?php echo json_encode($amount_sold); ?>,
        backgroundColor: ['#e84855', '#ff9b71', '#fffd82', '#2d3047', '#1b998b']
    }]
};
