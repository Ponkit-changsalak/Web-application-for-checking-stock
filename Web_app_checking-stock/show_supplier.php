...
if($_SESSION['Position'] != 'Admin' && $_SESSION['Position'] != 'GM' ){
    echo 
    '<script>
        window.location = "admin_show_supplier.php"; //หน้าที่ต้องการให้กระโดดไป
    </script>';
    exit();
}else
            ...
            <div class="row">
                <div class="col">
                    <h1 class=" text-dark">
                        Supplier
                        <!-- ปุ่มเพิ่ม -->
                        <a href="fr_Supplier.php" class="btn btn-1 btn-success shadow-sm">Add Supplier <img
                                src="png/building.png" alt="" width="25" height="25"></a>
                                ...
                                <div class="table-responsive">
                                    <table class="table caption-top table-striped ">
                                        <thead class="table-dark text-center ">
                                            <tr>
                                                <th>Import <img src="png/truck-side.png" alt="" width="25" height="25"></th>
                                                <th>ID</th>
                                                <th>Name</th>
                                                <th>Address</th>
                                                <th>ProductServiceType</th>
                                                <th>Manage</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody class="text-center">
                                            <?php
              $sql = "SELECT * FROM supplier as s inner join type_code as t on s.ProductServiceType = t.Type_code ";
              ...
              ?>
                                            ...
                                            <tr>
                                                <td>                                                
                                                    <a href="fr_im_product.php?id=<?=$row["SupplierID"]?>"
                                                                    class="btn btn-primary btn-sm mt-2 shadow"
                                                                    >Import Product +
                                                    </a>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group"
                                                        ...
                                                        <a href="edit_supplier.php?id=<?=$row["SupplierID"]?>"
                                                            class="btn btn-secondary text-white shadow">See more... </a>

                                                        <a href="delete_supplier.php?id=<?=$row["SupplierID"]?>"
